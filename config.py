...
class HParameters:
    ...
    def __init__(self):
        ...
        self.root = ''
        # self.datasets=['datasets/eccv16_dataset_tvsum_google_pool5.h5',
        # 'datasets/eccv16_dataset_summe_google_pool5.h5']

        self.datasets=[ 'datasets/breakfast_summarization_dataset.hdf5']
        self.splits=['splits/breakfast_splits_2.json']
        # self.splits = ['splits/tvsum_splits_10.json', 'splits/summe_splits_10.json']
